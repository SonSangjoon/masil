  ...
  if (
    ...
    const personFacingGuidance =
      action === "preview"
        ...
        : action === "move"
          ? "Acknowledge the exact move that became visible and say whose turn is next. Ground the reply in move and nextTurnOwner; do not mention tools or internal coordinates unless the person used coordinates."
          : undefined;
    return {
      ...result,
      structuredContent: {
