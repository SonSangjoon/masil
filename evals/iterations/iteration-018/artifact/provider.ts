        ...
        ...(context?.recoveredFrom
          ? {
              ...
              personFacingNextStep:
                "Tell the person the corrected reference is visible. Briefly ground the reply in calligraphy.character, calligraphy.meaning, and referenceImageAlt, then ask what they would like to do next. Do not mention the technical image defect.",
            }
          : {}),
      },
    };
  ...
  if (
    ...
    const personFacingGuidance =
      action === "preview"
        ...
        : action === "move"
          ? "In natural language, say the requested move was verified as legal and visibly completed, identify the exact piece and movement from move, then say whose turn is next from nextTurnOwner. Use the person's relative wording when possible; avoid tool narration and raw coordinates unless the person used them."
          : undefined;
    return {
      ...result,
      structuredContent: {
