      ...
      structuredContent: {
        ...
        ...(context?.recoveredFrom
          ? {
              ...
              providerVerifiedVisible: true,
              personFacingNextStep:
                "Confirm that MASIL verified the exact reference is visible. Ask one direct question about what the person wants next. Do not mention repair mechanics or claim either drawing input is ready.",
            }
          : {}),
      },
    };
